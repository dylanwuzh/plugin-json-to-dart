...
import com.dylanwuzh.plugin.utils.JsonUtils
import com.dylanwuzh.plugin.utils.MapTypeAdapter
...
class ModelGenerator(
    ...
    private fun generateClassDefinition(
        ...
        var newClassName = parentName + className
        ...
        if (jsonRawData is List<*>) {
            ...
            // 如果是list，就把名字修改成单数
            val classDefinition = ClassDefinition(newClassName)
            keys.forEach { key ->
